<?php
     ...
     */
    class WC_Gateway_Midtrans_InstallmentMIGS extends WC_Payment_Gateway {

      /**
       * Constructor
       */
      function __construct() {
        $this->id           = 'midtrans_installment_migs';
        $this->icon         = apply_filters( 'woocommerce_midtrans_icon', '' );
        $this->method_title = __( 'Midtrans Online Installment MIGS', 'woocommerce' );
        $this->has_fields   = true;
        $this->notify_url   = str_replace( 'https:', 'http:', add_query_arg( 'wc-api', 'WC_Gateway_Midtrans_InstallmentMIGS', home_url( '/' ) ) );
      ...
      public function admin_options() { ?>
        <h3><?php _e( 'Midtrans Online Installment MIGS', 'woocommerce' ); ?></h3>
      ...
      function init_form_fields() {
        ...
        $this->form_fields = array(
          'enabled' => array(
            ...
            'type' => 'checkbox',
            'label' => __( 'Enable Midtrans Online Installment MIGS Payment', 'woocommerce' ),
            'default' => 'no'
          ),
          'title' => array(
